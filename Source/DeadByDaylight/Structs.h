...
struct FCustomAnimData
{
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite)	
		TSoftObjectPtr<UAnimationAsset> MenuAnimationBlueprint;
	UPROPERTY(EditAnywhere, BlueprintReadWrite)	
		TSoftObjectPtr<UAnimationAsset> InGameAnimationBlueprint;
};
...
struct FBPAttachementSocketData
{
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite)
		TSoftObjectPtr<UBlueprint> AttachmentBlueprint;
	UPROPERTY(EditAnywhere, BlueprintReadWrite)
